...
- **Photon delivery verified:** the owner sent “Hi eve” to the new number. Photon then marked the contact `opt_in: true`, recipient availability checks succeeded, and the forwarded production webhook returned 200. Eve replied “Hi. I am here to manage your team within your set policies.” Photon reports that reply as sent and delivered. Registration alone had returned `Target not allowed for this project`; the first inbound message completed opt-in. The earlier uncertain setup test was suppressed as superseded and was never resent. Eve was then detached from the old Oura connector; Oura keeps its original sender and trigger destination.
